...
var poFns = {
  ...
  /** return true ({Promise}) if isPresent and isDisplayed
  **/
  makeIsVisibleFn: function(el) {
    return function() {
      return el.isPresent()
      .then(function(isp) {
        if(isp) {
  ...
  /** clear an input field by using backspace key
    ...
    *   Thanks @mcalthrop https://github.com/angular/protractor/issues/562#issuecomment-70309066
  **/ 
  clearByBs: function(el, options) {
    el.getValue().then(function (text) {
      var len = text.length; 
